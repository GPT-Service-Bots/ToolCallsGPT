...
manager_ids = [1815995090, 1274350249]


@register
async def send_user_info_kFgLQVD9(phone_number: str, additional_info: str, client_name: str):
...
async def send_unanswered_question_kFgLQVD9(question: str):
